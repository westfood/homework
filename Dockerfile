...
RUN apk add ansible coreutils py3-pip && pip3 install boto3 awscli boto botocore && rm -rf /var/cache/apk/*
...
# Python 2 boto/botocore is required by IAM ansible module.
